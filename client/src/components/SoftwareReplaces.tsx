...
const softwareData: Record<SoftwareKey, SoftwareInfo> = {
  ...
  deputy: { name: "Deputy", icon: <img src={deputyLogo} alt="Deputy" className="w-5 h-5 object-contain grayscale brightness-[2] opacity-70" /> },
  ...
  whenIWork: { name: "When I Work", icon: <img src={whenIWorkLogo} alt="When I Work" className="w-5 h-5 object-contain grayscale brightness-[2] opacity-70" /> },
