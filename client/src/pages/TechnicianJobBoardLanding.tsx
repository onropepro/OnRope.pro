      ...
      <section className="py-16 md:py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-2 border-border" data-testid="card-free-tier">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-3">
                    <Zap className="w-5 h-5 text-[#5C7A84] mt-0.5 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Clock className="w-5 h-5 text-[#5C7A84] mt-0.5 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Globe className="w-5 h-5 text-[#5C7A84] mt-0.5 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <DollarSign className="w-5 h-5 text-[#5C7A84] mt-0.5 shrink-0" />
                    <div>
            ...
            {/* PLUS Tier */}
            <Card className="border-2 border-[#5C7A84] relative overflow-hidden" data-testid="card-plus-tier">
              <div className="absolute top-0 right-0 bg-[#5C7A84] text-white text-xs font-semibold px-3 py-1 rounded-bl-lg">
                Free During Launch
              </div>
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between flex-wrap gap-2">
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <ToggleLeft className="w-5 h-5 text-[#5C7A84] mt-0.5 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Send className="w-5 h-5 text-[#5C7A84] mt-0.5 shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-3">
                    <Shield className="w-5 h-5 text-[#5C7A84] mt-0.5 shrink-0" />
                    <div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-[#5C7A84]/10 border border-[#5C7A84]/30 rounded-lg p-3">
                    <p className="text-sm font-medium text-[#5C7A84]">
          ...
          <div className="text-center mt-8">
            <Button size="lg" className="bg-[#5C7A84] hover:bg-[#4A656E] text-white" asChild data-testid="button-tier-get-plus">
          ...
          <div className="space-y-8">
            ...
            <Card className="border bg-white dark:bg-slate-950" data-testid="card-problem-1">
              <CardContent className="p-6 space-y-4">
                ...
                <div className="bg-[#5C7A84]/5 border border-[#5C7A84]/20 rounded-lg p-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              <div className="w-16 h-16 rounded-full bg-[#5C7A84] text-white flex items-center justify-center mx-auto text-2xl font-bold">
                1
              </div>
          ...
          <div className="text-center mt-12">
            <Button size="lg" className="bg-[#5C7A84] hover:bg-[#4A656E] text-white" asChild data-testid="button-how-create-account">
              <Link href="/technician?register=true">
        ...
        <div className="max-w-5xl mx-auto">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b bg-slate-50 dark:bg-slate-900">
                    ...
                    <th className="text-center p-4 font-semibold text-[#5C7A84]">OnRopePro</th>
          ...
          <Card className="mt-8 border-2 border-[#5C7A84]/30 bg-[#5C7A84]/5">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-[#5C7A84] font-medium mt-2">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="border bg-white dark:bg-slate-950">
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-[#5C7A84]/10 flex items-center justify-center mb-3">
                  <TrendingUp className="w-6 h-6 text-[#5C7A84]" />
                </div>
            ...
            <Card className="border bg-white dark:bg-slate-950">
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-[#5C7A84]/10 flex items-center justify-center mb-3">
                  <Users className="w-6 h-6 text-[#5C7A84]" />
                </div>
            ...
            <Card className="border bg-white dark:bg-slate-950">
              <CardHeader>
                <div className="w-12 h-12 rounded-lg bg-[#5C7A84]/10 flex items-center justify-center mb-3">
                  <Globe className="w-6 h-6 text-[#5C7A84]" />
                </div>
