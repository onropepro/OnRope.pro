            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
                <div className="text-center">
                  <div className="text-2xl md:text-3xl font-bold text-[#2874A6]">{t('safetyManifesto.stats.measured')}</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="relative overflow-hidden">
              <div className="absolute top-0 left-0 right-0 h-1" style={{backgroundColor: '#2874A6'}}></div>
              <CardHeader>
                <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-3" style={{backgroundColor: 'rgba(171, 69, 33, 0.1)'}}>
                  <UserCheck className="w-6 h-6" style={{color: '#2874A6'}} />
                </div>
      ...
      <section className="py-16 md:py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            {/* Stage 1 */}
            <Card className="border-l-4 border-l-[#2874A6] border-t-0 border-r-0 border-b-0 rounded-none bg-slate-50 dark:bg-slate-900">
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center font-bold text-white shrink-0" style={{backgroundColor: '#2874A6'}}>1</div>
                  <div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="relative overflow-hidden">
              ...
              <CardHeader>
                <div className="w-12 h-12 rounded-lg flex items-center justify-center mb-3" style={{backgroundColor: 'rgba(171, 69, 33, 0.1)'}}>
                  <HardHat className="w-6 h-6" style={{color: '#2874A6'}} />
                </div>
            ...
            <CardContent className="p-6 md:p-8 space-y-4">
              ...
              <div className="space-y-3 py-4">
                <div className="flex items-start gap-3">
                  <Target className="w-5 h-5 mt-0.5 text-[#2874A6]" />
