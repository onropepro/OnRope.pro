...
const GOAL_CONFIGS: Record<string, any> = {
  ...
  "pm-feature-definition": {
    ...
    chartColor: "#10b981",
    description: "Track free PM usage patterns and feedback to determine which features should be premium vs free. BM accounts remain FREE FOREVER. PM Premium features are TBD based on user research.",
    triggers: [
      { name: "PM Accounts", current: "totalClients", target: 100, unit: "", note: "Trigger for feature research" },
      { name: "Usage Tracking Active", current: null, target: 100, unit: "%", note: "Analytics in place" },
      { name: "PM Surveys Completed", current: null, target: 25, unit: "", note: "Direct feedback collected" },
    ],
    kpis: [
      { label: "Most used PM features identified", target: "Top 5", value: null },
      { label: "Pain points documented", target: "10+", value: null },
      { label: "Competitive analysis complete", target: "Yes", value: null },
      { label: "Value quantification done", target: "3+ features", value: null },
      { label: "Feature set finalized", target: "Ready", value: null },
    ],
    projectedGrowth: [
      { month: "Now", value: 0 },
      { month: "50 PMs", value: 50 },
      { month: "100 PMs", value: 100 },
      { month: "150 PMs", value: 150 },
    ],
    featureCategories: [
      { category: "Analytics", examples: "Portfolio compliance dashboard, vendor benchmarking, cost comparison" },
      { category: "Workflow", examples: "RFP/bid management, multi-vendor comparison, scheduling recommendations" },
      { category: "Reporting", examples: "Custom reports, board-ready exports, trend analysis" },
      { category: "Support", examples: "Priority support, dedicated account manager" },
      { category: "Integration", examples: "API access, property management software integration" },
    ],
  },
  "us-west": {
    part: 4,
  ...
  "unlimited-tier": {
    ...
    chartColor: "#f59e0b",
    description: "Push unlimited tier upgrades for large operators (40+ techs). Unlimited offers infinite projects, seats, and resident logins with priority support. Value prop: ~$50/tech vs $100+/tech on Enterprise.",
    triggers: [
      { name: "Enterprise Customers", current: null, target: 10, unit: "", note: "Proves market for large operators" },
      { name: "Enterprise NPS", current: null, target: 50, unit: "", note: "Customer satisfaction signal" },
      { name: "Limit Hits", current: null, target: 5, unit: "", note: "Enterprise users hitting caps" },
      { name: "40+ Tech Prospects", current: null, target: 20, unit: "", note: "Pipeline for Unlimited" },
    ],
    kpis: [
      { label: "Unlimited subscribers", target: "4+ (Y2)", value: null },
      { label: "Unlimited % of Enterprise", target: "8%", value: null },
      { label: "Unlimited revenue", target: "$96K ARR", value: null },
      { label: "4-hour response SLA", target: "Achieved", value: null },
    ],
    projectedGrowth: [
      { month: "Y1", value: 1 },
      { month: "Y2", value: 4 },
