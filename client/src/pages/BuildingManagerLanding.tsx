        ...
        <div className="relative max-w-6xl mx-auto px-4 py-4 md:py-12">
          <div className="text-center space-y-6 pt-16">
            <Badge className="bg-white/20 text-white border-white/30 text-sm px-4 py-1" data-testid="badge-building-manager">
              {t('buildingManagerLanding.hero.badge', 'For Building Managers')}
            </Badge>
            ...
            <div className="bg-white/10 rounded-lg p-4 max-w-2xl mx-auto mt-4">
              ...
              <p className="text-sm text-blue-100">
                {t('buildingManagerLanding.hero.autoAccountDetails', 'Your account is created automatically when a rope access company using OnRopePro starts a project on your building. Your login and initial password are both your strata/plan number (e.g., LMS1234).')}
              </p>
            </div>
          </div>
        </div>
