...
const stakeholderBenefits = [
  {
    ...
    benefits: [
      ...
      { headline: "Win contracts with your safety score", detail: "Company Safety Rating (CSR) visible to property managers. Document your toolbox meetings, harness inspections, and safety compliance. Stand out from competitors.", metric: "Higher contract win rate" },
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="py-16 md:py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4">
            What OnRopePro Does For Everyone In Your Operation
          </h2>
          <p className="text-center text-muted-foreground text-lg mb-12 max-w-2xl mx-auto">
