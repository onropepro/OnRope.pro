    ...
    >
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <Card className="bg-[#AB4521]/10 dark:bg-[#AB4521]/20 border-[#AB4521]/30">
            <CardContent className="pt-4">
              <div className="flex items-start gap-3">
                <Info className="w-5 h-5 text-[#AB4521] mt-0.5" />
                <div>
                  <p className="font-semibold text-[#AB4521] dark:text-[#DE7954]">Your Score Belongs to You</p>
                  <p className="text-base text-[#AB4521]/90 dark:text-[#DE7954]/90">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <Shield className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <CircleDot className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <TrendingUp className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <Eye className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <GraduationCap className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <RefreshCw className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <Clock className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card className="border-[#AB4521]/30 dark:border-[#AB4521]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#AB4521]/10 dark:bg-[#AB4521]/20">
                  <Users className="w-4 h-4 text-[#AB4521]" />
                </div>
                <div>
            ...
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold mb-3 flex items-center gap-2">
                  <Wrench className="w-4 h-4 text-[#AB4521]" />
                  PSR (Personal Safety Rating)
                </h3>
                <ul className="space-y-2 text-base text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="text-[#AB4521]">-</span>
