    ...
    >
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <Card className="bg-[#2874A6]/10 dark:bg-[#2874A6]/20 border-[#2874A6]/30">
            <CardContent className="pt-4">
              <div className="flex items-start gap-3">
                <Info className="w-5 h-5 text-[#2874A6] mt-0.5" />
                <div>
                  <p className="font-semibold text-[#2874A6] dark:text-[#DE7954]">Your Score Belongs to You</p>
                  <p className="text-base text-[#2874A6]/90 dark:text-[#DE7954]/90">
        ...
        <section className="space-y-4">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <Shield className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <CircleDot className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <TrendingUp className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <Eye className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <GraduationCap className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <RefreshCw className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <Clock className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card className="border-[#2874A6]/30 dark:border-[#2874A6]/50">
              <CardContent className="p-4 flex items-start gap-3">
                <div className="p-2 rounded-lg bg-[#2874A6]/10 dark:bg-[#2874A6]/20">
                  <Users className="w-4 h-4 text-[#2874A6]" />
                </div>
                <div>
            ...
            <Card>
              <CardContent className="p-4">
                <h3 className="font-semibold mb-3 flex items-center gap-2">
                  <Wrench className="w-4 h-4 text-[#2874A6]" />
                  PSR (Personal Safety Rating)
                </h3>
                <ul className="space-y-2 text-base text-muted-foreground">
                  <li className="flex items-start gap-2">
                    <span className="text-[#2874A6]">-</span>
