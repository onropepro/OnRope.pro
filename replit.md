...
*   **Building Manager (BM) Account:** Built and FREE FOREVER. Single-building scope with service history, anchor docs, vendor COI, safety rating, and project progress. Login via strata plan number + password.
*   **Property Manager (PM) Account:** Built and currently FREE. Multi-building scope across vendor relationships. PM Premium tier planned ($49/bldg/mo) after hitting tipping point (150+ PM accounts, 50%+ monthly engagement). PM Premium features TBD based on usage patterns.
