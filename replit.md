...
*   **Rope Access Specialties:** Technicians can select their specialized job types from all available categories (Building Maintenance, NDT, Rock Scaling, Wind Turbine, Oil Field). Specialties are displayed on technician profiles and visible to employers browsing the talent pool.
*   **Expanded Job Categories:** The system now supports five distinct job categories with category-specific progress tracking:
    - **Building Maintenance:** Traditional rope access work with drops/hours/suites/stalls/floors tracking and elevation requirements
    - **NDT (Non-Destructive Testing):** 11 specialized inspection types (ultrasonic, magnetic particle, radiographic, etc.) - hours-based tracking
    - **Rock Scaling:** 7 specialized rock work types (loose rock removal, mesh installation, bolt installation, etc.) - hours-based tracking
    - **Wind Turbine:** 9 turbine maintenance types (blade inspection, gearbox maintenance, tower climbing, etc.) - hours-based tracking, no floor count required
    - **Oil Field:** 15 oil/gas industry job types (tank inspection, pipeline work, refinery maintenance, offshore platform work, etc.) - hours-based tracking
