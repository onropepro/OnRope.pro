...
--> statement-breakpoint
CREATE TABLE "flha_forms" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"company_id" varchar NOT NULL,
	"project_id" varchar NOT NULL,
	"assessor_id" varchar NOT NULL,
	"assessment_date" date NOT NULL,
	"assessor_name" varchar NOT NULL,
	"job_description" text NOT NULL,
	"location" varchar NOT NULL,
	"work_area" varchar,
	"hazard_falling" boolean DEFAULT false NOT NULL,
	"hazard_swing_fall" boolean DEFAULT false NOT NULL,
	"hazard_suspended_rescue" boolean DEFAULT false NOT NULL,
	"hazard_weather" boolean DEFAULT false NOT NULL,
	"hazard_electrical" boolean DEFAULT false NOT NULL,
	"hazard_falling_objects" boolean DEFAULT false NOT NULL,
	"hazard_chemical" boolean DEFAULT false NOT NULL,
	"hazard_confined" boolean DEFAULT false NOT NULL,
	"hazard_sharp_edges" boolean DEFAULT false NOT NULL,
	"hazard_unstable_anchors" boolean DEFAULT false NOT NULL,
	"hazard_power_tools" boolean DEFAULT false NOT NULL,
	"hazard_public" boolean DEFAULT false NOT NULL,
	"control_ppe" boolean DEFAULT false NOT NULL,
	"control_backup_system" boolean DEFAULT false NOT NULL,
	"control_edge_protection" boolean DEFAULT false NOT NULL,
	"control_barricades" boolean DEFAULT false NOT NULL,
	"control_weather_monitoring" boolean DEFAULT false NOT NULL,
	"control_rescue_plan" boolean DEFAULT false NOT NULL,
	"control_communication" boolean DEFAULT false NOT NULL,
	"control_tool_tethering" boolean DEFAULT false NOT NULL,
	"control_permits" boolean DEFAULT false NOT NULL,
	"control_inspections" boolean DEFAULT false NOT NULL,
	"risk_level_before" varchar,
	"risk_level_after" varchar,
	"additional_hazards" text,
	"additional_controls" text,
	"emergency_contacts" text,
	"team_members" text[] DEFAULT ARRAY[]::text[] NOT NULL,
...
CREATE TABLE "gear_items" (
	...
	"rope_length" numeric(10, 2),
	"price_per_feet" numeric(10, 2),
...
CREATE TABLE "harness_inspections" (
	...
	"equipment_findings" jsonb DEFAULT '{}'::jsonb,
	"overall_status" varchar DEFAULT 'pass' NOT NULL,
	"frayed_edges" boolean,
	"broken_fibers" boolean,
	"pulled_stitching" boolean,
	"cuts_wear" boolean,
	"d_rings_chemical_damage" boolean,
	"d_rings_pads_excessive_wear" boolean,
	"d_rings_bent_distorted" boolean,
	"d_rings_cracks_breaks" boolean,
	"buckle_mechanism" boolean,
	"tongue_buckles_bent_distorted" boolean,
	"tongue_buckles_sharp_edges" boolean,
	"tongue_buckles_move_freely" boolean,
	"connectors_excessive_wear" boolean,
	"connectors_loose" boolean,
	"connectors_broken_distorted" boolean,
	"connectors_cracks_holes" boolean,
	"sharp_rough_edges" boolean,
	"burns_tears_cracks" boolean,
	"chemical_damage" boolean,
	"excessive_soiling" boolean,
	"connectors_hooks_work" boolean,
	"locking_mechanisms_work" boolean,
	"shock_absorber_intact" boolean,
	"excessive_wear_signs" boolean,
	"date_in_service" date,
	"comments" text,
	"pdf_url" text,
	"created_at" timestamp DEFAULT now()
...
CREATE TABLE "license_keys" (
	"license_key" varchar PRIMARY KEY NOT NULL,
	...
	CONSTRAINT "license_keys_stripe_session_id_unique" UNIQUE("stripe_session_id")
);
--> statement-breakpoint
...
CREATE TABLE "quotes" (
	...
	"strata_manager_name" varchar,
	"strata_manager_address" text,
	"photo_url" text,
...
CREATE TABLE "users" (
	...
	"linked_resident_code" varchar(10),
	"tech_level" varchar,
	...
	"subscription_tier" varchar DEFAULT 'none',
	...
	"whitelabel_branding_active" boolean DEFAULT false,
	"resident_code" varchar(10),
	"branding_logo_url" text,
	"branding_colors" text[] DEFAULT ARRAY[]::text[],
	"created_at" timestamp DEFAULT now(),
	"updated_at" timestamp DEFAULT now(),
	CONSTRAINT "users_email_unique" UNIQUE("email"),
	CONSTRAINT "users_resident_code_unique" UNIQUE("resident_code")
);
--> statement-breakpoint
...
ALTER TABLE "company_documents" ADD CONSTRAINT "company_documents_company_id_users_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "company_documents" ADD CONSTRAINT "company_documents_uploaded_by_id_users_id_fk" FOREIGN KEY ("uploaded_by_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "custom_job_types" ADD CONSTRAINT "custom_job_types_company_id_users_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "drop_logs" ADD CONSTRAINT "drop_logs_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "drop_logs" ADD CONSTRAINT "drop_logs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "flha_forms" ADD CONSTRAINT "flha_forms_company_id_users_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "flha_forms" ADD CONSTRAINT "flha_forms_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "flha_forms" ADD CONSTRAINT "flha_forms_assessor_id_users_id_fk" FOREIGN KEY ("assessor_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "gear_assignments" ADD CONSTRAINT "gear_assignments_gear_item_id_gear_items_id_fk" FOREIGN KEY ("gear_item_id") REFERENCES "public"."gear_items"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "gear_assignments" ADD CONSTRAINT "gear_assignments_company_id_users_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "gear_assignments" ADD CONSTRAINT "gear_assignments_employee_id_users_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "license_keys" ADD CONSTRAINT "license_keys_used_by_user_id_users_id_fk" FOREIGN KEY ("used_by_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "non_billable_work_sessions" ADD CONSTRAINT "non_billable_work_sessions_employee_id_users_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "work_sessions" ADD CONSTRAINT "work_sessions_employee_id_users_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "IDX_company_docs_company" ON "company_documents" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "IDX_company_docs_type" ON "company_documents" USING btree ("company_id","document_type");--> statement-breakpoint
CREATE INDEX "IDX_custom_job_types_company" ON "custom_job_types" USING btree ("company_id");--> statement-breakpoint
CREATE INDEX "IDX_flha_company_date" ON "flha_forms" USING btree ("company_id","assessment_date");--> statement-breakpoint
CREATE INDEX "IDX_flha_project" ON "flha_forms" USING btree ("project_id","assessment_date");--> statement-breakpoint
CREATE INDEX "IDX_flha_assessor" ON "flha_forms" USING btree ("assessor_id","assessment_date");--> statement-breakpoint
CREATE INDEX "IDX_gear_assignments_item" ON "gear_assignments" USING btree ("gear_item_id");--> statement-breakpoint
CREATE INDEX "IDX_gear_assignments_employee" ON "gear_assignments" USING btree ("employee_id");--> statement-breakpoint
CREATE INDEX "IDX_gear_assignments_company" ON "gear_assignments" USING btree ("company_id");--> statement-breakpoint
...
CREATE INDEX "IDX_non_billable_sessions_company_date" ON "non_billable_work_sessions" USING btree ("company_id","work_date");--> statement-breakpoint
CREATE INDEX "IDX_non_billable_sessions_employee" ON "non_billable_work_sessions" USING btree ("employee_id");--> statement-breakpoint
...
CREATE INDEX "IDX_toolbox_meetings_conductor" ON "toolbox_meetings" USING btree ("conducted_by","meeting_date");--> statement-breakpoint
CREATE INDEX "IDX_work_sessions_company_project_date" ON "work_sessions" USING btree ("company_id","project_id","work_date");--> statement-breakpoint
CREATE INDEX "IDX_work_sessions_employee_project" ON "work_sessions" USING btree ("employee_id","project_id");